...
const Header = () => {
  // fixed
  //Ở đây có thể hiệu khúc useSelector giúp truy cập tới initialState
  const { hoTen } = useSelector((state) => state.nguoiDung);
  console.log(hoTen);
  return (
    <div>
      <nav className="bg-white dark:bg-gray-900 w-full fixed z-20 top-0 left-0 border-b border-gray-200 dark:border-gray-600">
